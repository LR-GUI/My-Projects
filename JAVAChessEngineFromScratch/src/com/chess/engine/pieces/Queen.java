...
public class Queen extends Piece {
    // queen is a type of piece
    // this class is concerned with the properties of the queen
    // properties of pieces consist only of how they move and attack

    // following the Tile coordinate convention, these are the relative coordinates to the queen's position
    // that are its standard legal move destinations, the queens's rook+bishop move
    // all destinations are multiples of these eight numbers, representing each direction and diagonal
    ...
    public Queen(final Alliance pieceAlliance, final int piecePosition) {
        super(PieceType.QUEEN, pieceAlliance, piecePosition, true); // class instantiation taking alliance and position of the queen

    }

    public Queen(final Alliance pieceAlliance, final int piecePosition, final boolean isFirstMove) {
        super(PieceType.QUEEN, pieceAlliance, piecePosition, isFirstMove); // class instantiation taking alliance and position of the queen
                ...
                if (BoardUtils.isValidTileCoordinate(candidateDestinationCoordinate)) {
                    ...
                    if (!candidateDestinationTile.isTileOccupied()) {
                        ...
                        break; // if the destination is occupied, this break removes the rest of the diagonal
                               // or direction that is blocked by this occupying piece
                    }
                }
            }
        }
    ...
    public Queen movePiece(final Move move) {
        return new Queen(move.getPieceMoved().getPieceAlliance(), move.getDestinationCoordinate());
    }
    ...
    // Edge cases for the queen, used above
    // for the first and last columns, two of the diagonals and one direction break and have to be discarded
